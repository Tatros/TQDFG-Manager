...
namespace StatsAnalyzer.ExecutionEngine
{
    ...
    using MatlabProcessContainer = ExecutionEngine.UniqueProcessContainer<ExecutionEngine.MatlabApplicationProcess>;
    ...
    public class MatlabExecutionEngine : ExecutionEnvironment, IObserver<bool>
    {
        ...
        private void RestartProcess()
        {
            ...
            //matlabApp = new WeakReference<object>(Activator.CreateInstance(matlabtype));
            matlabApp = new WeakReference<object>(matlabProcess.GetProcess(this));
        }
