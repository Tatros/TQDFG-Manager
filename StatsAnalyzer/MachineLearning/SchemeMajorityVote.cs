...
{
    internal class SchemeMajorityVote
    {
        ...
        internal SchemeMajorityVote(Dictionary<string, NodeClassification> nodeClassifications)
        {
        ...
        private void compute(Dictionary<string, NodeClassification> nodeClassifications)
        {
            ...
            foreach (var kvp in nodeClassifications)
            {
                ...
                voterPredictedConf.Add(decision);
                ...
                if (kvp.Value.ActualClass >= 0) // malware
                {
                    ...
                    if (decision >= 0) // malware predicted
                        VTP++;
                ...
                else if (kvp.Value.ActualClass < 0)
                {
                    ...
                    if (decision < 0) // goodware predicted
                        VTN++;
                ...
                String majorityVote = (decision == kvp.Value.ActualClass) ? "Success" : "Fail";
